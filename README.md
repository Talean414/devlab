...
4. Watcher events flag the index as possibly stale; it is never rebuilt automatically — click **Rebuild index** when you want fresh results. Semantic (embedding) search is not part of this phase; the status line says so explicitly.
