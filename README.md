...
- Permission-gated multi-file draft staging for Project Builder, including per-task batch staging with a session-only metadata ledger, with no automatic workspace writes
