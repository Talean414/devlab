...
- Continue refining style-guide and quality defaults beyond the current prompt guidance: strict TypeScript, Biome or ESLint/Prettier configs, sensible test setup, accessibility checks and conventional project structure.
