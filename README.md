...
- Explicit editor-side application of approved drafts through scoped native writes and revision checks
...
2. Open **Self-Healing Tests / Native Test Runner**. In Phase 6C this panel runs real tests, can draft a one-file repair for review, and applies a reviewed draft only after an explicit user click.
