...
const stats = [
  { label: "Migration phase", value: "6A / 7" },
...
const quickCards: { view: ViewId; Icon: typeof Bot; title: string; desc: string; hot?: boolean }[] = [
  ...
  { view: "healer",   Icon: Stethoscope,  title: "Native Test Runner",    desc: "Run detected workspace tests with bounded native processes" },
...
const features = [
  ...
  { Icon: Stethoscope,title: "Native test runner",           desc: "Discover package, Cargo, Go and pytest profiles from the selected workspace and run them through bounded Rust-owned processes." },
      ...
      <section className="relative overflow-hidden border-b border-white/5">
        ...
        <div className="relative mx-auto max-w-5xl px-8 py-16">
          ...
          <p className="mt-5 max-w-2xl text-lg text-zinc-400 text-pretty">
            ...
            bounded SQLite plus verified PostgreSQL connectivity, fixed schema inspection, bounded reads, separately confirmed writes, a native HTTP client with no browser CORS path, and a real bounded test runner. Unavailable operations stay disabled until their native backends are implemented.
          </p>
