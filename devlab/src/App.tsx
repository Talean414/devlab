  ...
  function render() {
    switch (view) {
      ...
      case "agent":    return <AgentPanel
        ...
        canDependencies={hasNativeCapability(runtime, "filesystem") && hasNativeCapability(runtime, "dependency-inventory")}
      ...
      {settings.showStatusBar && (
        ...
        >
          <div className="flex items-center gap-4">
            <span className="flex items-center gap-1.5"><CheckCircle2 className="h-3 w-3" /> Phase 9R honest deploy and CI authoring</span>
